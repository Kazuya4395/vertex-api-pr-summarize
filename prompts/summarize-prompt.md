...
- [ ] 💎 Style: コードの動作に影響しないスタイルの変更（フォーマット、セミコロンなど）
- [ ] ♻️ Refactor: 機能的な変更を伴わないリファクタリング
- [ ] ⚡️ Performance: パフォーマンスを向上させるための変更
- [ ] ✅ Test: テストの追加や修正
- [ ] 📦 Build: ビルドシステムや外部依存に関する変更 (npm, webpackなど)
- [ ] 🎡 CI: CI設定ファイルやスクリプトに関する変更 (GitHub Actionsなど)
- [ ] 🧹 Chore: 上記のいずれにも分類されないその他の変更
